...
const Input = () => {
  ...
  const [currentSelectedFirstName, setCurrentSelectedFirstName] = useState();
  ...
  return (
    <div className="input-div">
      ...
      />
      <div className={change ? "drop-input-active" : "drop-input"}>
        {Data.filter((val) => {
          if (searchLetter == "") {
            return val;
          } else if (
          ...
          return (
            ...
            >
              <div
                onClick={() => setCurrentSelectedFirstName(val.first_name)}
                className="input-drop-list-pick"
              >
                <span>{val.profession}</span>
                <span>{val.first_name}</span>
              </div>

              {currentSelectedFirstName === val.first_name ? (
